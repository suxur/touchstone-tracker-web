...
export const InactiveEncounter = () => {
  ...
  const hasNoCombatant = useMemo(() => encounter.combatants.length === 0, [encounter.combatants.length]);
        ...
        {hasNoCombatant && (
          <ListBody className="mb-2 sm:mb-4">
            <div className="rounded-md bg-white flex flex-col flex-grow justify-center items-center py-10">
              <div
                className="rounded-full h-28 w-28 border-4 border-purple-700 bg-gray-100 justify-center items-center flex mb-10"
              >
              ...
              <p className="text-center mb-4 mx-8">
                You can't have an encounter without combatants. Add a monster or character from the codex to get
                started.
              </p>
            </div>
          </ListBody>
