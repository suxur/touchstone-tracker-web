...
export const CombatantRow = forwardRef<HTMLDivElement, Props>(({
  active, combatant, encounter, draggableProps, dragHandleProps,
}: Props, ref) => {
  ...
  return (
    <div ref={ref} className={clsx('flex', active ? 'bg-purple-300' : 'odd:bg-white even:bg-gray-50')} {...draggableProps}>
      ...
      <div className="flex flex-col flex-grow">
        <div className={clsx('flex flex-row flex-grow h-12 max-h-12 mt-2 justify-between space-x-2 md:space-x-4', { 'font-bold': active })}>
